...
//        log.info("string id list: " + docIds);
        String[] docIds = new String[6000000];
        Random rgen = new Random();
        for (int i = 0; i < 6000000; i++) {
            docIds[i] = Integer.toString(rgen.nextInt(8900000));
        }

        String[] shortendDocIds = (String[])ArrayUtils.subarray(docIds, 0, 100);
        ...
        try {
            ...
            log.info("ids: " + StringUtils.substring(ids, 0, 100) + "...");
